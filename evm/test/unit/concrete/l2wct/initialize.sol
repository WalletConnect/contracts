...
contract Initialize_L2WCT_Unit_Concrete_Test is Base_Test {
    ...
    function setUp() public override {
        ...
        WCT.Init memory wctInit = WCT.Init({ initialAdmin: users.admin });
    ...
    function test_revertWhen_InitialAdminIsZero() public {
        L2WCT.Init memory init = L2WCT.Init({
            ...
            initialBridge: address(legacyMockOptimismBridge)
        });
    ...
    function test_initialize() public {
        ...
        assertEq(l2wct.crosschainBridge(), address(legacyMockOptimismBridge));
