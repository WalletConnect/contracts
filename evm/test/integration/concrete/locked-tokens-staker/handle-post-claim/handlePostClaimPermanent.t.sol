 ...
 */
contract HandlePostClaimPermanent_LockedTokenStaker_Integration_Concrete_Test is LockedTokenStaker_Integration_Shared_Test {
    ...
    function test_GivenPermanentLockAllowsPartialClaims() external {
        ...
        assertEq(
            ...
            initialBalance + claimableAmount, 
            "Should receive claimable amount"
        );
    ...
    function test_GivenPermanentCanUnlockAndEventuallyWithdraw() external {
        ...
        assertEq(
            ...
            "Should receive full amount after unlock"
        );
