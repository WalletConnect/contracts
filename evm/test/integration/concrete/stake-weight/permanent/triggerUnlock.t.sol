...
contract TriggerUnlock_StakeWeight_Integration_Concrete_Test is StakeWeight_Integration_Shared_Test {
    ...
    function test_WhenLockIsPerpetual() external whenContractIsNotPaused whenLockIsPerpetual {
        ...
        assertGt(stakeWeight.userPointHistory(users.alice, userEpochAfter).slope, 0, "Slope should be positive for decaying");
        ...
        uint256 historicalPerpetualBalance = stakeWeight.balanceOfAt(
            users.alice, 
            blockBeforeTrigger
        );
